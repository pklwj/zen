...
window-rule { match app-id=r"fcitx5"; open-floating true; draw-border-with-background true; }
layer-rule { match namespace=r"^noctalia-backdrop$"; place-within-backdrop true; }
...
binds {
    ...
    Mod+D hotkey-overlay-title="Run an Application: fuzzel" { spawn-sh "noctalia msg panel-toggle launcher"; }
